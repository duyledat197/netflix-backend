...
func (c *categoryServiceClient) GetListCategory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetListCategoryResponse, error) {
...
func _CategoryService_GetListCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetListCategory(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
